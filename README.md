...
Giả sử bạn đang tìm kiếm trên Google về nội dung về hướng dẫn học python cơ bản. Thay vì chỉ gõ **hướng dẫn học python cơ bản** vào hộp tìm kiêm của Google, có thể sẽ tốt hơn khi tìm kiêm một các rõ ràng với cụm từ. Để thực hiện việc này, chỉ cần đưa cụm từ tìm kiếm vào dấu nháy kép "...".

Ví du tìm kiếm: _"hướng dẫn học python cơ bản"_
<img width="1440" alt="Screen Shot 2021-04-04 at 18 14 31" src="https://user-images.githubusercontent.com/78150336/113506910-b9718600-9571-11eb-9aeb-1c86a144e85b.png">

**2. Loại trừ Từ muốn tìm kiếm** (... -_từ loại trừ_)
...
**4. Hiển thị các từ trong văn bản** (... allintext: ...)
...
Ví dụ Tìm kiếm: allintext: Quy trình skincare 

**5. Các từ trong Text + Tiêu đề, URL** (... intext: ...)
...
Ví dụ Tìm kiếm: hierarchical deep neural network intext:HAN

**6. Tìm các từ trong Tiêu đề** (allintitle:...)
...
Ví dụ Tìm kiếm: allintitle: vacine COVID-19

**7. Các từ trong Title + Text, URL** (... intitle: ...)
...
**8. Tìm kiếm Các từ trong URL** (allinurl: ...)
...
**9. Cách tìm kiếm trong một trang web** (site: somesite.com. "...")
...
Ví dụ Tìm kiếm: site:leapcontent.vn "hướng dẫn học photoshop" 
